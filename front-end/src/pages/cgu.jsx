...
const Cgu = () => {
    return (
        <div className="container mx-auto p-6 max-w-3xl">
            <h1 className="text-3xl text-green-700 font-bold mb-6">Conditions générales d'utilisation</h1>

            <section className="mb-4">
                <h2 className="text-xl text-green-700 font-semibold mb-2">1. Objet</h2>
                <p>
            ...
            <section className="mb-4">
                <h2 className="text-xl text-green-700 font-semibold mb-2">2. Accès au jeu</h2>
                <p>
            ...
            <section className="mb-4">
                <h2 className="text-xl text-green-700 font-semibold mb-2">3. Règles de conduite</h2>
                <p>
            ...
            <section className="mb-4">
                <h2 className="text-xl text-green-700 font-semibold mb-2">4. Données personnelles</h2>
                <p>
            ...
            <section className="mb-4">
                <h2 className="text-xl text-green-700 font-semibold mb-2">5. Modifications</h2>
                <p>
